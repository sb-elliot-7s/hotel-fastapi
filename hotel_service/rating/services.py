...
class RatingService:
    ...
    async def rate_apartment(self, account, apartment_id: str, rate_data: RateApartmentSchema):
        return await self.__repository \
            .rate_apartment(account=account, apartment_id=apartment_id, rate_apartment_data=rate_data)
